    ...
    <div className="w-full">
      <Card className="w-full shadow-md rounded-none flex flex-row justify-between items-center px-14 py-4">
        ...
        <div className="flex flex-row gap-12 items-center w-full justify-center">
          <a
            href="#features"
            className="text-sm font-medium text-gray-500 hover:translate-y-1 transition-all duration-200"
          >
            Features
          </a>
        ...
        <div className="flex flex-row gap-6 items-center w-full justify-end">
          <Link href="/login">
            <Button
              variant="outline"
              size="lg"
              className="min-w-30 cursor-pointer hover:shadow-md hover:translate-y-1 "
            >
              Login
            </Button>
          </Link>
