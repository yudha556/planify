...
type DocumentStyle = "profesional" | "formal" | "concise";

export function ProjectInfoStep({ setStep }: Props) {
  const [selectStyle, setSelectStyle] = useState<DocumentStyle | null>(null);
